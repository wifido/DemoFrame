...
public class PcompSoftware extends UserHistoryMessageVo implements Serializable{
    private String id;

    private String pcompKindId;
    ...
    public String getPcompKindId() {
        return pcompKindId;
    }

    public void setPcompKindId(String pcompKindId) {
        this.pcompKindId = pcompKindId == null ? null : pcompKindId.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", pcompKindId=").append(pcompKindId);
