...
public interface PathConstants {
    ...
    String PCOMP_VERSION_PLATFORM_DOWNLOAD_CREATE_PATH = PCOMP_PATH + Constants.FOLDER_PATH_SEPARATOR + PcompConstants.PCOMP_VERSION_PLATFORM_DOWNLOAD + CREATE_PATH;
    String PCOMP_VERSION_PLATFORM_DOWNLOAD_MODIFICATION_PATH = PCOMP_PATH + Constants.FOLDER_PATH_SEPARATOR + PcompConstants.PCOMP_VERSION_PLATFORM_DOWNLOAD + UPDATE_PATH;
    String PCOMP_VERSION_PLATFORM_DOWNLOAD_REMOVE_PATH = PCOMP_PATH + Constants.FOLDER_PATH_SEPARATOR + PcompConstants.PCOMP_VERSION_PLATFORM_DOWNLOAD + REMOVE_PATH;
    String PCOMP_VERSION_DOCUMENT_DOWNLOAD_CREATE_PATH = PCOMP_PATH + Constants.FOLDER_PATH_SEPARATOR + PcompConstants.PCOMP_VERSION_DESCRIPTION_DOCUMENT + CREATE_PATH;
    String PCOMP_VERSION_DOCUMENT_DOWNLOAD_MODIFICATION_PATH = PCOMP_PATH + Constants.FOLDER_PATH_SEPARATOR + PcompConstants.PCOMP_VERSION_DESCRIPTION_DOCUMENT + UPDATE_PATH;
    String PCOMP_VERSION_DOCUMENT_DOWNLOAD_REMOVE_PATH = PCOMP_PATH + Constants.FOLDER_PATH_SEPARATOR + PcompConstants.PCOMP_VERSION_DESCRIPTION_DOCUMENT + REMOVE_PATH;
