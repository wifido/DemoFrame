 ...
 * @date 2016/8/13
 */
public interface PagePathConstants {
    ...
    static final String KNNET_HOMEPAGE_PATH = "/knnet/index";
    static final String COMMUNITY_HOMEPAGE_PATH = "/community/index";
    static final String ACADEMY_HOMEPAGE_PATH = "/academy/index";
}
