...
<div class="row">
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a href="<%out.print(PathUtils.makePath(PagePathConstants.KNNET_HOMEPAGE_PATH));%>" target="_self" class="hero">
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a href="<%out.print(PathUtils.makePath(PagePathConstants.COMMUNITY_HOMEPAGE_PATH));%>" target="_self" class="hero">
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a href="<%out.print(PathUtils.makePath(PagePathConstants.PCOMP_HOMEPAGE_PATH));%>" target="_self" class="hero">
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a href="<%out.print(PathUtils.makePath(PagePathConstants.ACADEMY_HOMEPAGE_PATH));%>" target="_self" class="hero">
