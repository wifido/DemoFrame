...
! function(a, b) {
	...
	! function(a) {
			...
			var h, i = this.each(function() {
				...
				if(b.is("select")) {
					...
					if(c) {
						...
						var k = a.extend({}, f.DEFAULTS, a.fn.selectpicker.defaults || {}, b.data(), i);
						k.template = a.extend({}, f.DEFAULTS.template, a.fn.selectpicker.defaults ? a.fn.selectpicker.defaults.template : {}, b.data().template, i.template), b.data("selectpicker", c = new f(this, k, g))
					}
			...
			clickListener: function() {
				...
				this.$newElement.on("touchstart.dropdown", ".dropdown-menu", function(a) {
					...
					if(b.multiple && 1 !== b.options.maxOptions && c.stopPropagation(), c.preventDefault(), !b.isDisabled() && !d.parent().hasClass("disabled")) {
						...
						} else i.prop("selected", !1), j.prop("selected", !0), b.$menuInner.find(".selected").removeClass("selected").find("a").attr("aria-selected", !1), b.setSelected(e, !0);
		...
		a.fn.selectpicker = d, a.fn.selectpicker.Constructor = f, a.fn.selectpicker.noConflict = function() {
